...
class Componente extends Conectar
{
    ...
    public function buscarComponente($pagina = 1) {
        ...
        try {
            ...
            OR  cc.nombre_clase LIKE '$textoBusqueda%'
            OR  ma.nombre_marca LIKE '$textoBusqueda%'
            OR  m.nombre_modelo LIKE '$textoBusqueda%'
            OR  serie LIKE '$textoBusqueda%'
            ORDER BY tp.nombre_tipo_componente LIMIT $inicio,$limit ";
