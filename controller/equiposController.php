...
switch ($accion) {
    ...
    case "guardarEquipo":
        //var_dump($_POST);
        $codeq="";
        if(is_null($_POST['inputCodigo'])){
            $codeq="";
        }else{
            $codeq=$_POST['inputCodigo'];
        }
        $equipo -> guardarEquipo($codeq,$_POST['serie'],$_POST['margesi'],$_POST['selMarcaEquipo'],$_POST['selModeloEquipo'],$_POST['selTipoEquipo'],$_POST['selArea'],$_POST['respValue'],$_POST['selEstado'],$_POST['ip'],$_POST['mac']);
        break;
