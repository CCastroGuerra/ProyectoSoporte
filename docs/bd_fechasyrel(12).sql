...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2023 a las 15:23:54
...
(15, 27, 1, 2, '2023-08-09 16:56:05'),
(16, 27, 1, 2, '2023-08-09 17:02:51');
...
(27, 'P027', 'toner pruena', 5, 3, 0, 1, 'es una prueba', 1, '2023-08-07 17:55:36', '2023-08-09 17:02:51');
...
CREATE TABLE `servicios` (
  ...
  `tipoTrabajo` int(11) DEFAULT NULL COMMENT '1-> Para pc\r\n2-> Para impresora\r\n3-> Ambos',
  `requiere_consumible` int(11) NOT NULL,
  `esActivo` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 2, 7, 1, 4, 'as', '', '', 'P027 ', 1, '2023-08-09 17:02:45', NULL, NULL);
...
(1, 2, 7, 6, 1, '2023-08-09 17:02:51', NULL, NULL);
...
--
ALTER TABLE `movimientos`
  MODIFY `id_movimientos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=12;
...
--
ALTER TABLE `temp_servicios`
  MODIFY `id_temp_servicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `trabajo_servicio`
  MODIFY `id_trabajo_servicio` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=2;
