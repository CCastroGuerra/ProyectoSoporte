...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-08-2023 a las 15:21:21
...
INSERT INTO `componentes` (`id_componentes`, `tipo_componentes_id`, `clase_componentes_id`, `marca_id`, `modelo_id`, `serie`, `componentes_capacidad`, `estado_id`, `producto_id`, `tipo_alimentacion`, `tipo_conector`, `es_activo`, `fecha_alta`, `fecha_borrado`, `fecha_modify`) VALUES
(3, 3, 1, 2, 2, 'CL16', '16', 1, NULL, 1, 'VGA', 0, '2023-07-11 20:15:57', '2023-07-31 17:12:25', '2023-08-03 16:49:19'),
(4, 6, 1, 7, 5, '304NDUNB5382', '10', 3, NULL, NULL, NULL, 0, '2023-07-17 18:00:51', '2023-07-31 17:16:07', '2023-07-31 17:16:07'),
(5, 7, 1, 8, 6, '0065818951042', '10', 1, NULL, NULL, NULL, 0, '2023-07-18 13:56:22', '2023-07-31 17:26:53', '2023-07-31 17:26:53'),
(6, 8, 2, 8, 7, 'X821908-014', '12', 1, NULL, 1, 'VGA', 1, '2023-07-18 13:56:52', NULL, '2023-08-03 16:49:32'),
(7, 2, 2, 1, 1, '#123456', '0', 1, NULL, NULL, NULL, 0, '2023-07-25 15:24:26', '2023-07-31 17:20:00', '2023-07-31 17:20:00'),
(8, 6, 1, 2, 12, '6CM32332L90', '0', 3, NULL, NULL, NULL, 0, '2023-08-03 15:26:27', '2023-08-03 15:27:58', '2023-08-03 15:27:58'),
(9, 6, 1, 2, 2, '432423432', '', 3, NULL, 2, 'HDMI', 1, '2023-08-03 17:04:48', NULL, '2023-08-03 17:12:59');
...
(2, 'E000002', 'MXL3272LVCsdasda', '454545454545', 2, 2, 3, 4, 2, 1, '192.168.10.86', '88-51-FB-64-64-7D', NULL, NULL, '2023-07-17 16:03:20', '2023-08-02 16:43:42', NULL, 1),
(3, 'E000003', '22120023849', '740899500137', 1, 1, 4, 3, 3, 1, '192.168.10.72', 'EC-A8-6B-76-E7-CD', NULL, NULL, '2023-07-18 15:55:39', '2023-07-31 13:41:22', NULL, 1),
...
(11, 'HP COMPAQ ELITE 8300 SFF', 2, 1),
(12, 'HP LV1911', 2, 1);
...
--
ALTER TABLE `componentes`
  MODIFY `id_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `detalles_translado`
--
ALTER TABLE `detalles_translado`
  MODIFY `id_detalles_translado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `equipos`
--
ALTER TABLE `equipos`
  MODIFY `id_equipos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `equipo_componentes`
--
ALTER TABLE `equipo_componentes`
  MODIFY `id_equipo_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=19;
...
--
ALTER TABLE `modelo`
  MODIFY `id_modelo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=13;
...
--
ALTER TABLE `temp_componentes`
  MODIFY `id_temp_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=278;

--
-- AUTO_INCREMENT de la tabla `temp_servicios`
--
ALTER TABLE `temp_servicios`
  MODIFY `id_temp_servicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `trabajos`
  MODIFY `id_trabajos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `trabajo_servicio`
--
ALTER TABLE `trabajo_servicio`
  MODIFY `id_trabajo_servicio` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=12;
