...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2023 a las 15:34:28
...
END $$ CREATE DEFINER = `root` @`localhost` PROCEDURE `sp_insertar_productos` (
  IN `p_nombre` VARCHAR(100),
  IN `p_tipo` INT,
  IN `p_presentacion` INT,
  IN `p_cantidad` INT,
  IN `p_almacen` INT,
...
SET v_codigo = (
    SELECT CONCAT('P', LPAD(COUNT(*) + 1, 3, '0'))
    FROM productos
  );
...
INSERT INTO `area` (`id_area`, `nombre_area`, `esActivo`)
VALUES (2, 'ADMINISTRACION', 1),
  (3, 'ADMISION', 1),
  (4, 'ADOLESCENCIA', 1),
  (5, 'ALMACEN GENERAL', 1),
...
VALUES (3, 1, 1, 'D', 0, '2023-07-25 16:16:43'),
...
INSERT INTO `categoria_marca` (`id_categoria_marca`, `nombre_categoria_marca`)
VALUES (1, 'MONITORES '),
  (2, 'COMPONENTES'),
...
INSERT INTO `clase_componentes` (
    `id_clase_componentes`,
    `nombre_clase`,
    `esActivo`
  )
VALUES (1, 'Externo', 1),
...
--
DELIMITER $$
CREATE TRIGGER `COMPONENTE_ISACTIVO_BEFORE_LASTUPDATE` BEFORE
UPDATE ON `componentes` FOR EACH ROW BEGIN IF(old.es_activo <> new.es_activo) THEN IF(new.es_activo = 0) THEN
SET new.fecha_borrado = CURRENT_TIMESTAMP;
ELSE
SET new.fecha_borrado = null;
END IF;
END IF;
END $$ DELIMITER;
-- --------------------------------------------------------
...
INSERT INTO `detalles_translado` (
    `id_detalles_translado`,
    `id_translado`,
    `area_origen`,
    `area_destino`,
    `tipo`,
...
--
DELIMITER $$
CREATE TRIGGER `DESP_AGREGARENEQUIPO`
AFTER
INSERT ON `equipo_componentes` FOR EACH ROW BEGIN
set @id = (
    select id_componentes
    from componentes
...
END $$ DELIMITER;
DELIMITER $$ CREATE TRIGGER `DESP_ELIMINARDEEQUIPO`
AFTER
UPDATE ON `equipo_componentes` FOR EACH ROW BEGIN IF (new.esActivo = 0) THEN
update componentes
set es_activo = 1
where serie = new.serie_id;
END IF;
...
--
DELIMITER $$
CREATE TRIGGER `despuesdenuevamarca`
AFTER
INSERT ON `marca` FOR EACH ROW BEGIN
insert into modelo (nombre_modelo, marca_id, `esActivo`)
values("Sin modelo", new.id_marca, 1);
END $$ DELIMITER;
-- --------------------------------------------------------
--
...
VALUES (1, 1, 1, 2, '2023-07-11 22:45:50'),
...
--
DELIMITER $$
CREATE TRIGGER `PERSONAL_ISACTIVO_BEFORE_LASTUPDATE` BEFORE
UPDATE ON `personal` FOR EACH ROW BEGIN IF(old.esActivo_personal <> new.esActivo_personal) THEN IF(new.esActivo_personal = 0) THEN
SET new.erase_time = CURRENT_TIMESTAMP;
ELSE
SET new.erase_time = null;
END IF;
END IF;
END $$ DELIMITER;
-- --------------------------------------------------------
...
VALUES (
  ...
  (
    3,
    'P003',
    'Switch PoE 4 Puertos DS-3E0105P-E/M',
    4,
    1,
    4,
    1,
    '-Ideal para cámara IP, Access Point, Telefono IP de cualquier marca.\r\n-Modelo DS-3E0105P-E/M(B).\r\nCaracteristicas principales\r\n- 4 x 10/100 Base-T PoE 802.3af/at.\r\n- 1,2 - Puerto uplink 100 Mbps',
    1,
    '2023-07-11 15:14:29',
    '2023-07-17 17:54:59'
  ),
  ...
  (
    11,
    'P011',
    'ADAPTADOR DE CORRIENTE PARA MONITOR LG',
    2,
    1,
    10,
    1,
    '-Fuente poder certificado LG 19v 2,1A\r\n-Para monitores LG DE 0,8A A 3.0A de consumo de corriente\r\n-Potencia 40W',
    1,
    '2023-07-11 16:05:20',
    '2023-07-17 17:54:59'
  ),
  ...
  (
    ...
    2,
    1,
    '-Mini Desarmador 30 en 1\r\n-Kit de desarmador con 30 puntas',
    1,
    '2023-07-11 16:32:12',
    '2023-07-17 17:54:59'
  ),
  (
    21,
    'P021',
    'TORNILLOS SUJETA COOLER',
    4,
    4,
    1,
    1,
    '-Tornillos de 7/32(5.5mm)',
    1,
    '2023-07-11 16:33:52',
    '2023-07-17 17:54:59'
  ),
  (
    ...
    0,
    1,
    '-Soplador Aspiradora 800w Industrial Auto Casa Hotel Aire Pc.\r\n-Modelo TB2086',
    1,
    '2023-07-11 16:35:26',
    '2023-07-17 17:54:59'
  ),
...
INSERT INTO `tipo_componentes` (
    `id_tipo_componentes`,
    `nombre_tipo_componente`,
    `esActivo`
  )
VALUES (2, 'Disco Duro', 1),
  (3, 'Memoria Ram', 1),
  (4, 'Procesador', 1),
  (5, 'Ventilación', 1),
  (6, 'Monitor', 1),
...
INSERT INTO `tipo_equipo` (`id_tipo_equipo`, `nombre_tipo_equipo`)
VALUES (1, 'COMPUTADORA DE ESCRITORIO'),
  (2, 'IMPRESORA'),
  (3, 'LAPTOP'),
  (4, 'TODO EN UNO');
-- --------------------------------------------------------
...
VALUES (6, 6, 4, 7, 1, '2023-07-31 17:02:29', NULL, NULL),
...
VALUES (4, '2023-08-03 14:40:01', '', 2, 1, 0),
  (
    5,
    '2023-08-07 15:38:27',
    'Se requiere equipo',
...
--
ALTER TABLE `area`
MODIFY `id_area` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 30;
--
-- AUTO_INCREMENT de la tabla `bajas`
--
ALTER TABLE `bajas`
MODIFY `id_bajas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 7;
--
...
--
ALTER TABLE `clase_componentes`
MODIFY `id_clase_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 4;
--
-- AUTO_INCREMENT de la tabla `componentes`
--
ALTER TABLE `componentes`
MODIFY `id_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 12;
--
-- AUTO_INCREMENT de la tabla `detalles_translado`
--
ALTER TABLE `detalles_translado`
MODIFY `id_detalles_translado` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 9;
--
-- AUTO_INCREMENT de la tabla `equipos`
--
ALTER TABLE `equipos`
MODIFY `id_equipos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 20;
--
-- AUTO_INCREMENT de la tabla `equipo_componentes`
--
ALTER TABLE `equipo_componentes`
MODIFY `id_equipo_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 20;
--
-- AUTO_INCREMENT de la tabla `estado`
--
ALTER TABLE `estado`
MODIFY `id_estado` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 4;
--
...
--
ALTER TABLE `marca`
MODIFY `id_marca` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 35;
--
-- AUTO_INCREMENT de la tabla `modelo`
--
ALTER TABLE `modelo`
MODIFY `id_modelo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 136;
--
...
--
ALTER TABLE `personal`
MODIFY `id_personal` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 5;
--
-- AUTO_INCREMENT de la tabla `presentacion`
--
ALTER TABLE `presentacion`
MODIFY `id_presentacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 6;
--
...
--
ALTER TABLE `productos`
MODIFY `id_productos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 28;
--
-- AUTO_INCREMENT de la tabla `roles`
--
ALTER TABLE `roles`
MODIFY `id_roles` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 5;
--
...
--
ALTER TABLE `rol_usuario`
MODIFY `id_rol_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 4;
--
...
--
ALTER TABLE `servicios`
MODIFY `id_servicios` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 8;
--
...
--
ALTER TABLE `temp_componentes`
MODIFY `id_temp_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 287;
--
-- AUTO_INCREMENT de la tabla `temp_servicios`
--
ALTER TABLE `temp_servicios`
MODIFY `id_temp_servicios` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 113;
--
-- AUTO_INCREMENT de la tabla `tipo_componentes`
--
ALTER TABLE `tipo_componentes`
MODIFY `id_tipo_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 9;
--
-- AUTO_INCREMENT de la tabla `tipo_equipo`
--
ALTER TABLE `tipo_equipo`
MODIFY `id_tipo_equipo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 5;
--
-- AUTO_INCREMENT de la tabla `trabajos`
--
ALTER TABLE `trabajos`
MODIFY `id_trabajos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 12;
--
-- AUTO_INCREMENT de la tabla `trabajo_servicio`
--
ALTER TABLE `trabajo_servicio`
MODIFY `id_trabajo_servicio` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 13;
--
-- AUTO_INCREMENT de la tabla `translado`
--
ALTER TABLE `translado`
MODIFY `id_translado` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 10;
--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key',
  AUTO_INCREMENT = 5;
--
