...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2023 a las 15:14:38
...
(3, 3, 1, 2, 2, 'CL16', 16, 1, NULL, 0, '2023-07-11 20:15:57', '2023-07-31 17:12:25', '2023-07-31 17:12:25'),
(4, 6, 1, 7, 5, '304NDUNB5382', 10, 3, NULL, 0, '2023-07-17 18:00:51', '2023-07-31 17:16:07', '2023-07-31 17:16:07'),
(5, 7, 1, 8, 6, '0065818951042', 10, 1, NULL, 0, '2023-07-18 13:56:22', '2023-07-31 17:26:53', '2023-07-31 17:26:53'),
(6, 8, 2, 8, 7, 'X821908-014', 12, 1, NULL, 1, '2023-07-18 13:56:52', NULL, '2023-07-31 17:31:52'),
(7, 2, 2, 1, 1, '#123456', 0, 1, NULL, 0, '2023-07-25 15:24:26', '2023-07-31 17:20:00', '2023-07-31 17:20:00');
...
(1, 'E000001', '22120022119', '740899500150', 1, 1, 1, 5, 3, 1, '192.168.10.1', 'EC-A8-6B-76-30-03', '2023-07-14 17:33:26', '2023-07-25 16:20:28', NULL, 0),
(2, 'E000002', 'MXL3272LVC', '740899500019    ', 2, 2, 3, 4, 2, 1, '192.168.10.86', '88-51-FB-64-64-7D', '2023-07-17 16:03:20', '2023-07-31 14:38:31', NULL, 1),
(3, 'E000003', '22120023849', '740899500137', 1, 1, 4, 3, 3, 1, '192.168.10.72', 'EC-A8-6B-76-E7-CD', '2023-07-18 15:55:39', '2023-07-31 13:41:22', NULL, 1),
(4, 'E000004', 'R5X7Z00016', '742223580028', 9, 9, 2, 3, 3, 3, 'USB', '', '2023-07-19 14:09:21', '2023-07-31 16:33:59', NULL, 1),
(5, 'E000005', '1234568', '455434', 9, 9, 1, 18, 3, 1, '', '', '2023-07-31 17:07:12', NULL, NULL, 1),
(6, 'E000006', 'adasda', '545', 8, 7, 1, 11, 1, 1, '192.168.10.25', '2F:4G:5T:1S', '2023-07-31 17:10:59', NULL, NULL, 1),
(7, 'E000007', '45345', '5535', 7, 5, 2, 4, 1, 1, '', '', '2023-07-31 17:12:16', NULL, NULL, 1),
(8, 'E000008', '24234234', '01020304', 4, 4, 1, 3, 1, 1, '', '', '2023-07-31 17:15:01', '2023-07-31 17:26:53', NULL, 1),
(9, 'E000009', '432423432', '324324234', 8, 6, 1, 3, 3, 1, '', '', '2023-07-31 17:15:37', NULL, NULL, 1),
(10, 'E000010', '43432432', '6747657657', 8, 7, 2, 13, 2, 2, '', '', '2023-07-31 17:17:21', NULL, NULL, 1),
(11, 'E000011', '42342344', '545435', 8, 6, 1, 28, 3, 1, '', '', '2023-07-31 17:19:05', NULL, NULL, 1),
(12, 'E000012', '32132133', '2131242343', 7, 5, 1, 13, 2, 1, '', '', '2023-07-31 17:19:44', NULL, NULL, 1),
(13, 'E000013', '12312312321', '2313123123', 9, 9, 1, 10, 1, 1, '', '', '2023-07-31 17:23:03', NULL, NULL, 1),
(14, 'E000014', '22120022', '740899500150', 3, 3, 1, 5, 3, 1, '', '', '2023-07-31 17:24:07', NULL, NULL, 1),
(15, 'E000015', '24234234', '01020304', 4, 4, 1, 3, 1, 1, '', '', '2023-07-31 17:26:09', NULL, NULL, 1),
(16, 'E000016', '3123123', '1231', 2, 2, 1, 13, 3, 1, '', '', '2023-07-31 17:30:12', NULL, NULL, 1);
...
(7, '1113', 8, 1),
(8, 'DG43NB', 3, 1),
(9, 'ECOSYS M4132IDN', 9, 1),
(10, 'ECOSYS M2640IDW', 9, 1);
...
(26, 'P026', 'TONER', 4, 1, 0, 1, 'TONER PARA IMPRESORAS', 1, '2023-07-20 13:31:01', '2023-07-21 15:09:08');
...
(1, 'admin', 'HoVF6jXqXxc9.', 1, 1, '2023-07-11 13:55:27', '2023-07-26 14:45:43', NULL);
...
--
ALTER TABLE `componentes`
  MODIFY `id_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `detalles_translado`
--
ALTER TABLE `detalles_translado`
  MODIFY `id_detalles_translado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `equipos`
--
ALTER TABLE `equipos`
  MODIFY `id_equipos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `equipo_componentes`
--
ALTER TABLE `equipo_componentes`
  MODIFY `id_equipo_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=18;
...
--
ALTER TABLE `marca`
  MODIFY `id_marca` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `modelo`
--
ALTER TABLE `modelo`
  MODIFY `id_modelo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=11;
...
--
ALTER TABLE `productos`
  MODIFY `id_productos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=27;
...
--
ALTER TABLE `temp_componentes`
  MODIFY `id_temp_componentes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=276;

--
-- AUTO_INCREMENT de la tabla `temp_servicios`
--
ALTER TABLE `temp_servicios`
  MODIFY `id_temp_servicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `trabajos`
  MODIFY `id_trabajos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=8;
...
--
ALTER TABLE `translado`
  MODIFY `id_translado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
