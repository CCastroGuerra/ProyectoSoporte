...
-- Tiempo de generación: 10-08-2023 a las 13:55:00
...
CREATE TABLE `almacen` (
  `id_almacen` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `area` (
  `id_area` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `bajas` (
  `id_bajas` int NOT NULL COMMENT 'primary key',
  `equipo_id` int DEFAULT NULL,
  `tipo_baja` int NOT NULL COMMENT '1 = Temporal\r\n2 = Permanente',
...
CREATE TABLE `categoria` (
  `id_categoria` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `categoria_marca` (
  `id_categoria_marca` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `clase_componentes` (
  `id_clase_componentes` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `componentes` (
  ...
  `margesi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `componentes_capacidad` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `estado_id` int DEFAULT NULL,
  `producto_id` int DEFAULT NULL,
  `tipo_alimentacion` int DEFAULT '1' COMMENT '1->CABLE DE PODER\r\n2-> TRANFORMADOR\r\n\r\n',
  `tipo_conector` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'VGA',
...
CREATE TABLE `detalles_translado` (
  `id_detalles_translado` int NOT NULL,
  `id_translado` int NOT NULL,
  `area_origen` int NOT NULL,
  `area_destino` int NOT NULL,
  `tipo` int NOT NULL COMMENT '1-Translado o 2-Intercambio',
  `equipo_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `equipos` (
  `id_equipos` int NOT NULL COMMENT 'primary key',
  `cod_equipo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `serie` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `margesi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `marca_id` int DEFAULT NULL,
  `modelo_id` int DEFAULT NULL,
  ...
  `usuario_local` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_alta` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_modify` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `fecha_borrado` timestamp NULL DEFAULT NULL,
  `es_activo` int DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `equipo_componentes` (
  `id_equipo_componentes` int NOT NULL COMMENT 'primary key',
  `equipo_id` int DEFAULT NULL,
  `serie_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha_alta` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_modify` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `fecha_borrado` timestamp NULL DEFAULT NULL,
  `esActivo` int NOT NULL DEFAULT '1'
...
CREATE TABLE `estado` (
  `id_estado` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `inventario` (
  `id_inventario` int NOT NULL COMMENT 'primary key',
  `producto_id` int DEFAULT NULL,
...
CREATE TABLE `movimientos` (
  ...
  `cantidad` int NOT NULL,
  `tipo_movimientos` int NOT NULL COMMENT '1 = Entrada\r\n2 = Salida',
...
CREATE TABLE `permisos` (
  `id_permisos` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `permisos_secciones` (
  `id_permisos_secciones` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `presentacion` (
  `id_presentacion` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `procedimientos` (
  `id_procedimientos` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `productos` (
  `id_productos` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `roles` (
  `id_roles` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `roles_permisos` (
  `id_roles_permisos` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `rol_usuario` (
  `id_rol_usuario` int NOT NULL COMMENT 'primary key',
  `rol_id` int NOT NULL,
...
CREATE TABLE `secciones` (
  `id_secciones` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `servicios` (
  `id_servicios` int NOT NULL COMMENT 'primary key',
  `nombre_servicios` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipoTrabajo` int DEFAULT '2' COMMENT '1 -> Cambio de tinta\r\n0 -> Otro trabajo',
  `requiere_consumible` int NOT NULL,
  `esActivo` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `servicios` (`id_servicios`, `nombre_servicios`, `tipoTrabajo`, `requiere_consumible`, `esActivo`) VALUES
(1, 'Formateo', 1, 0, 1),
(2, 'Cambio de Tinta', 2, 1, 1),
(3, 'Limpieza', 3, 0, 1),
(4, 'Mantenimiento Preventivo', 3, 0, 1),
(5, 'Cambio de pasta termica', 1, 0, 1),
(6, 'Cambio de Cinta', 2, 1, 1),
(7, 'Cambio de Toner', 2, 1, 1);
...
CREATE TABLE `servicios_procedimientos` (
  `id_servicios_procedimientos` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `temp_componentes` (
  `id_temp_componentes` int NOT NULL COMMENT 'primary key',
  `id_equipo_componentes` int DEFAULT NULL,
  `equipo_id` int DEFAULT NULL,
  `serie_comp` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `margesi` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `temp_servicios` (
  `id_temp_servicios` int NOT NULL,
  `id_trabajo_servicio` int DEFAULT NULL,
...
CREATE TABLE `tipo_componentes` (
  `id_tipo_componentes` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `tipo_equipo` (
  `id_tipo_equipo` int NOT NULL COMMENT 'primary key',
...
CREATE TABLE `trabajos` (
  `id_trabajos` int NOT NULL COMMENT 'primary key',
  `tecnico_id` int DEFAULT NULL,
  `equipo_id` int DEFAULT NULL,
  `responsable_id` int DEFAULT NULL,
  `area_id` int DEFAULT NULL,
  `falla` text COLLATE utf8mb4_general_ci,
  `solucion` text COLLATE utf8mb4_general_ci,
  `recomendacion` text COLLATE utf8mb4_general_ci,
  `codigo_productos` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `es_activo` int DEFAULT '1',
  `fecha_alta` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_modify` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `fecha_borrado` timestamp NULL DEFAULT NULL
...
CREATE TABLE `translado` (
  ...
  `tipo_movimiento` int NOT NULL COMMENT '1-> Translado\r\n2-> Intercambio',
  `anulado` int DEFAULT '0' COMMENT '1->anulado\r\n0->activo\r\n'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `almacen`
  MODIFY `id_almacen` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `area`
--
ALTER TABLE `area`
  MODIFY `id_area` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `bajas`
--
ALTER TABLE `bajas`
  MODIFY `id_bajas` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `categoria`
--
ALTER TABLE `categoria`
  MODIFY `id_categoria` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `categoria_marca`
--
ALTER TABLE `categoria_marca`
  MODIFY `id_categoria_marca` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `clase_componentes`
--
ALTER TABLE `clase_componentes`
  MODIFY `id_clase_componentes` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `componentes`
--
ALTER TABLE `componentes`
  MODIFY `id_componentes` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `detalles_translado`
--
ALTER TABLE `detalles_translado`
  MODIFY `id_detalles_translado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `equipos`
--
ALTER TABLE `equipos`
  MODIFY `id_equipos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `equipo_componentes`
--
ALTER TABLE `equipo_componentes`
  MODIFY `id_equipo_componentes` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `estado`
--
ALTER TABLE `estado`
  MODIFY `id_estado` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `inventario`
--
ALTER TABLE `inventario`
  MODIFY `id_inventario` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';
...
--
ALTER TABLE `movimientos`
  MODIFY `id_movimientos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `permisos`
--
ALTER TABLE `permisos`
  MODIFY `id_permisos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `permisos_secciones`
--
ALTER TABLE `permisos_secciones`
  MODIFY `id_permisos_secciones` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `personal`
--
ALTER TABLE `personal`
  MODIFY `id_personal` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `presentacion`
--
ALTER TABLE `presentacion`
  MODIFY `id_presentacion` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `procedimientos`
--
ALTER TABLE `procedimientos`
  MODIFY `id_procedimientos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `id_productos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `roles`
--
ALTER TABLE `roles`
  MODIFY `id_roles` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `roles_permisos`
--
ALTER TABLE `roles_permisos`
  MODIFY `id_roles_permisos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `rol_usuario`
--
ALTER TABLE `rol_usuario`
  MODIFY `id_rol_usuario` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `secciones`
--
ALTER TABLE `secciones`
  MODIFY `id_secciones` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `servicios`
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `servicios_procedimientos`
--
ALTER TABLE `servicios_procedimientos`
  MODIFY `id_servicios_procedimientos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key';

--
-- AUTO_INCREMENT de la tabla `temp_componentes`
--
ALTER TABLE `temp_componentes`
  MODIFY `id_temp_componentes` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=287;

--
-- AUTO_INCREMENT de la tabla `temp_servicios`
--
ALTER TABLE `temp_servicios`
  MODIFY `id_temp_servicios` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT de la tabla `tipo_componentes`
--
ALTER TABLE `tipo_componentes`
  MODIFY `id_tipo_componentes` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tipo_equipo`
--
ALTER TABLE `tipo_equipo`
  MODIFY `id_tipo_equipo` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `trabajos`
--
ALTER TABLE `trabajos`
  MODIFY `id_trabajos` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `trabajo_servicio`
--
ALTER TABLE `trabajo_servicio`
  MODIFY `id_trabajo_servicio` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `translado`
--
ALTER TABLE `translado`
  MODIFY `id_translado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int NOT NULL AUTO_INCREMENT COMMENT 'primary key', AUTO_INCREMENT=5;
