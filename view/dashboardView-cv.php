      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-primary">
          <div class="card-body pb-0">
            <div class="row col-lg-12 d-flex justify-content-between align-items-start" style="margin-right: 0px;margin-left: 0px;">
              <div class="col-lg-9">
                <div class="fs-4 fw-semibold"><?php echo  $total_usuarios; ?></div>
                <div>Usuarios</div>
              </div>
              <div class="text-end col-lg-3 dropdown">
            ...
            <div class="row col-lg-12">
              ...
              <div class="text-end">
                <img src="../img/user-interface.png" width="" height="" style="margin-left: 0px;width: 61%;" class="text-end">
              </div>
            </div>
          </div>
        ...
        <div class="card mb-4 text-white bg-info">
          <div class="card-body pb-0">
            ...
            <div class="row col-lg-12">
              <!-- <canvas class="chart" id="card-chart1" height="70"></canvas> -->
              <div class="text-end">
                <img src="../img/box_full_products_14639.png" width="" height="" style="margin-left: 0px;width: 61%;" class="text-end">
              </div>
            </div>
          </div>
        ...
        <div class="card mb-4 text-white bg-warning">
          <div class="card-body pb-0">
            ...
            <div class="row col-lg-12">
              <!-- <canvas class="chart" id="card-chart1" height="70"></canvas> -->
              <div class="text-end">
                <img src="../img//work-tools.png" width="" height="" style="margin-left: 0px;width: 61%;" class="text-end">
              </div>
            </div>
          </div>
        ...
        <div class="card mb-4 text-white bg-danger">
          <div class="card-body pb-0">
            ...
            <div class="row col-lg-12">
              <!-- <canvas class="chart" id="card-chart1" height="70"></canvas> -->
              <div class="text-end">
                <img src="../img/icons8-reciclar-64(1).png" width="" height="" style="margin-left: 0px;width: 61%;" class="text-end">
              </div>
            </div>
          </div>
