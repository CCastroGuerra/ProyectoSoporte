...
<div class="modal fade" id="añadirEquipo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <div class="col-xs-1-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4">Lista de componentes <button type="button" class="btn btn-outline-primary" data-coreui-toggle="modal" data-coreui-target="#añadirComponente"><strong>Añadir</strong></button></h3>
                </div>
            </div>
        </div>
        <div class="col-xs-1-12">
...
<div class="col-md-12 col-lg-12 ">
    <div class="row ">
        <div class="col-xs-1-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4">Lista de Equipos <button type="button" class="btn btn-outline-primary" data-coreui-toggle="modal" data-coreui-target="#añadirEquipo"><strong>Añadir</strong></button></h3>
                    <div class="row">
                    <div class="col-md-3">
    ...
    <form id="frmArea">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Registro de componentes</h3>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="mb-2">Codigo:</label>
                    ...
                    <label for="exampleInputEmail1" class="mb-2">Marca:</label>
                    <input type="text" class="form-control mb-2" id="codigo" name="marca" placeholder="Ingrese marca">
                    ...
                    <label for="exampleInputEmail1" class="mb-2">Memoria:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Intel</option>
                    </select>
                    <label for="exampleInputEmail1" class="mb-2">Disco Duro:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">298 GB</option>
                    </select>
                    <label for="exampleInputEmail1" class="mb-2">Sistema operativo:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Microsoft Windows 07 Professional</option>
                    </select>
                    <label for="exampleInputEmail1" class="mb-2">Usuario / Cliente:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Luis</option>
                        <option value="2">Carlos</option>
                        <option value="3">Esteban</option>
                    </select>
                    <label for="exampleInputEmail1" class="mb-2">Clave:</label>
                    <input type="password" class="form-control mb-2" id="codigo" name="codigo" placeholder="Ingrese codigo">
                    
                    <label for="exampleInputEmail1" class="mb-2">Tipo de alimentacion:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Bueno</option>
                        <option value="2">Regular</option>
                    ...
                    <label for="exampleInputEmail1" class="mb-2">Tipo de conexion:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Bueno</option>
                        <option value="2">Regular</option>
