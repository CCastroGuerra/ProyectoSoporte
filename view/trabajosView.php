    ...
    <form id="frmArea">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="mb-2">Nombre:</label>
                    <input type="text" class="form-control mb-2" id="nombreArea" name="nombreArea" placeholder="Ingrese Trabajo">
                    ...
                    <label for="exampleInputEmail1" class="mb-2">Servicios:</label>
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Open this select menu</option>
                        <option value="1">Bueno</option>
                        <option value="2">Regular</option>
                    ...
                    <label for="exampleInputEmail1" class="mb-2">Descripción:</label>
                    <input type="textarea" class="form-control mb-2" id="nombreArea" name="nombreArea" placeholder="Descripcion...">
                    <div id="alerta"></div>
                </div>
            </div>
...
<div class="col-md-8 col-lg-7 ">
    <div class="row ">
        <div class="col-xs-1-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4">Lista Trabajos</h3>
